...
class ProjectStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_status" do
    assert_difference("ProjectStatus.count") do
      post project_statuses_url, params: { project_status: { project_id: @project_status.project_id, status_id: @project_status.status_id, tansition_date: @project_status.tansition_date } }
    end
  ...
  test "should update project_status" do
    patch project_status_url(@project_status), params: { project_status: { project_id: @project_status.project_id, status_id: @project_status.status_id, tansition_date: @project_status.tansition_date } }
